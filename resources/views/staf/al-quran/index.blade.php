...
<div class="w-full bg-gray-100 p-6">
    <div class="flex justify-between justify-items-center items-center mb-4">
        <h1 class="text-2xl font-bold">Al-Quran Learning</h1>
        <a href="{{ route('staff.al-quran.create-assessment') }}"
            class="bg-blue-600 hover:bg-blue-700 text-white font-semibold font-base px-4 py-3 rounded-lg transition-colors flex text-center">
                ...
                <table class="w-full border rounded-md border-collapse text-sm p-4" id="table">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b hover:bg-gray-100">
                            ...
                            <td class="p-3 whitespace-nowrap font-medium text-base">
                                {{ $assessment->subcategory->category->nama ?? 'N/A' }}
                            </td>
                            <td class="p-3 whitespace-nowrap font-medium text-base">
                                {{ $assessment->subcategory->sub_nama ?? 'N/A' }}
                            </td>
                            ...
                            <td class="p-3 whitespace-nowrap font-medium text-base">
                                <span class="text-gray-700 hover:underline flex gap-4">
                                    <div x-data="{ open: false }">
                                        ...
                                        <div x-show="open" x-cloak class="fixed z-50 inset-0 overflow-y-auto"
                                            ...
                                            <div class="flex items-center justify-center min-h-screen px-4">
                                                ...
                                                <!-- Modal Content -->
                                                <div
                                                    class="bg-white rounded-lg overflow-hidden shadow-xl transform transition-all sm:max-w-lg sm:w-full md:max-w-xl">
                                                    <!-- Modal Header -->
                                                    <div
                                                        class="bg-blue-600 py-4 px-6 text-white flex justify-between">
                                                    ...
                                                    <form
                                                        ...
                                                        <div class="mb-4">
                                                            <div
                                                                class="flex flex-col md:flex-col justify-between mb-4">
                                                                <div
                                                                    class="mb-4 md:mb-0 flex flex-col md:flex-col w-full gap-3">
                                                                    <input type="text" id="siswa_id"
                                                                        name="siswa_id"
                                                                        class="shadow-sm p-2 border border-gray-300 bg-gray-50 text-gray-700 block w-full rounded-md cursor-not-allowed"
                                                                        value="{{ $assessment->siswa->nama }}"
                                                                        readonly>
                                                                    <input type="text" id="subcategory_id"
                                                                        name="subcategory_id"
                                                                        class="shadow-sm p-2 border border-gray-300 bg-gray-50 text-gray-700 block w-full rounded-md cursor-not-allowed"
                                                                        value="{{ $assessment->subcategory->category->nama }} - {{ $assessment->subcategory->sub_nama }}"
                                                                        readonly>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="mb-4">
                                                                <label
                                                                    class="block text-sm font-medium text-gray-700 mb-2">Predicate
                                                                ...
                                                                <div class="grid grid-cols-5 gap-2">
                                                                    ...
                                                                    <label
                                                                        ...
                                                                        <input type="radio" name="predicate"
                                                                            ...
                                                                            required>
                                                                        <span
                                                                            class="ml-2 text-sm">{{ $predicate }}</span>
                                                                    </label>
                                                                    @error('predicate')
                                                            ...
                                                            <div class="mb-4">
                                                                ...
                                                                <textarea id="explanation-{{ $assessment->id }}" name="explanation" rows="3"
                                                                    ...
                                                                    placeholder="Add details about the student's performance">{{ $assessment->explanation }}</textarea>
                                                                @error('explanation')
                                                                <p id="outlined_error_help" class="mt-2 text-xs text-red-700">
                                                                    {{ $message }}
                                                                </p>
                                                        ...
                                                        <div
                                                            ...
                                                            <button type="submit"
                                                                class="update-btn px-4 py-2 text-base font-medium bg-blue-600 text-white rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500">
                                                                Update Assessment
                                                            </button>
                                                        </div>
                                                    </form>
                                            ...
                                            <div class="relative top-40 mx-auto p-5 border w-1/3 shadow-lg rounded-md bg-white"
                                                ...
                                                <div class="mt-3 text-center">
                                                    ...
                                                    <div class="flex justify-center mt-4 gap-4">
                                                        <form
                                                            action="{{ route('staff.al-quran.delete-assessment', $assessment->id) }}"
