...
<div class="w-full bg-gray-100 p-6">
    ...
    <div class="bg-white p-6 shadow-md rounded-lg">
        ...
        <form action="{{ route('staff.al-quran.store-new-assessment') }}" method="POST" class="space-y-6" id="assessmentForm">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        <label for="subcategory_id" class="block text-base font-medium text-gray-700 mb-1">Sub-Category
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-3">Predicate <span
                                class="text-red-600">*</span></label>
                        <div class="grid grid-cols-5 gap-2" id="predicate-container">
            ...
            <div class="space-y-6 pt-4">
                ...
                <div>
                    ...
                    <textarea id="explanation" name="explanation" rows="4"
                        ...
                        placeholder="Select sub-category first to enable this field" disabled>{{ old('explanation') }}</textarea>
                    @error('explanation')
                    <p id="outlined_error_help" class="mt-2 text-xs text-red-700">
                        {{ $message }}
                    </p>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function toggleFormElements(enabled) {
            ...
            if (!enabled) {
                explanationTextarea.placeholder = 'Select sub-category first to enable this field';
            } else {
                explanationTextarea.placeholder = 'Add details about the student\'s Al-Quran learning performance';
            }
        ...
        function checkFormValidity() {
            ...
            const isValid = subcategorySelected && studentSelected && predicateSelected && explanationFilled;
        ...
        subcategorySelect.addEventListener('change', function() {
            ...
            if (subcategoryId) {
                ...
                // Fetch students for selected subcategory
                fetch(`{{ route('staff.al-quran.students-by-subcategory') }}?subcategory_id=${subcategoryId}`)
                ...
                studentSelect.innerHTML = '<option value="">Select Sub-Category first</option>';
