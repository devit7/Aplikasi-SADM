...
<div class="flex-1 p-6 bg-white text-gray-800 min-h-screen">
   ...
   <div class="border-b border-gray-200 pb-4 mb-6 header-section">
      <div class="flex justify-between items-center">
         <h1 class="text-2xl font-bold text-gray-800">Worship & Character - Assessments</h1>
         <a href="{{ route('staff.worship.create-assessment') }}" class="bg-blue-500 hover:bg-blue-600 font-semibold text-base text-white py-3 px-3 rounded-md transition flex items-center">
            ...
            <table class="w-full border rounded-md border-collapse text-sm p-4" id="table">
               <thead>
                  <tr class="bg-gray-50 border-b">
                     <th class="p-3 text-left font-medium text-gray-600 cursor-pointer whitespace-nowrap">No</th>
                     <th class="p-3 text-left font-medium text-gray-600 cursor-pointer whitespace-nowrap">Student</th>
                     <th class="p-3 text-left font-medium text-gray-600 cursor-pointer whitespace-nowrap">Category</th>
                     <th class="p-3 text-left font-medium text-gray-600 cursor-pointer whitespace-nowrap">Predicate</th>
                     <th class="p-3 text-left font-medium text-gray-600 cursor-pointer whitespace-nowrap">Updated At</th>
                     <th class="p-3 text-left font-medium text-gray-600 cursor-pointer whitespace-nowrap">Created By</th>
                     <th class="p-3 text-center font-medium text-gray-600 whitespace-nowrap">Action</th>
                  </tr>
               </thead>
               <tbody>
                  ...
                  <tr class="border-b hover:bg-gray-100">
                     ...
                     <td class="p-3 whitespace-nowrap font-medium text-base">{{ $assessment->category->nama ?? 'N/A' }}</td>
                     <td class="p-3 whitespace-nowrap text-center font-semibold text-base">
                        <span class="px-8 py-2 inline-flex text-sm leading-5 font-semibold rounded-full 
                        ...
                        : ($assessment->predicate == 'D' ? 'bg-orange-100 text-orange-800' 
                        : 'bg-red-100 text-red-800'))) }}">
                           {{ $assessment->predicate }}
                        </span>
                     </td>
                     <td class="p-3 whitespace-nowrap font-medium text-base">{{ $assessment->updated_at->format('d M Y') }}</td>
                     <td class="p-3 whitespace-nowrap font-medium text-base">{{ $assessment->created_by ?? 'N/A' }}</td>
                     <td class="p-3 whitespace-nowrap text-center font-medium text-base">
                              ...
                              <div x-show="openEditModal" x-cloak class="fixed z-50 inset-0 overflow-y-auto"
                                 ...
                                 <div class="flex items-center justify-center min-h-screen px-4">
                                    ...
                                    <div class="bg-white rounded-lg overflow-hidden shadow-xl transform transition-all sm:max-w-lg sm:w-full md:max-w-xl">
                                       ...
                                       <!-- Modal Body -->
                                       <form action="{{ route('staff.worship.update-assessment', $assessment->id) }}"
                                             ...
                                             <div class="flex flex-col md:flex-col justify-between mb-4">
                                                <div class="mb-4 md:mb-0 flex flex-col md:flex-col w-full gap-3">
                                                   ...
                                                   <input type="text"
                                                      ...
                                                      readonly>
                                                   <input type="hidden" name="category_id" value="{{ $assessment->category_id }}">
                                                   <input type="hidden" name="siswa_id" value="{{ $assessment->siswa_id }}">
                                                </div>
                                             </div>
                                 ...
                                 <div class="relative top-40 mx-auto p-5 border w-1/3 shadow-lg rounded-md bg-white"
                                    ...
                                    <div class="mt-3 text-center">
                                       ...
                                       <div class="flex justify-center mt-4 gap-4">
                                          <form
                                             action="{{ route('staff.worship.delete-assessment', $assessment->id) }}"
