                ...
                <table class="w-full rounded-md mx-3 py-2" id="absenTable">
                    <thead>
                        <tr class="bg-gray-200">
                            ...
                            <th class="border px-6 py-3 text-center text-sm font-medium text-gray-700 uppercase tracking-wider">Action</th>
                        </tr>
                    </thead>
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium border text-center">
                                <a href="{{ route('walas.manajemen-absen.show', $item->tanggal) }}" class="bg-gray-100 hover:bg-gray-200 px-3 py-1 rounded-md">
                                    ✏️
                                </a>
                            </td>
                        </tr>
