                ...
                <div class="flex items-center space-x-3">
                    ...
                    <div class="text-white">
                        ...
                        <p class="text-sm opacity-80">
                            {{ \Carbon\Carbon::now()->locale('id')->isoFormat('dddd, DD MMM YYYY') }}</p>
                    </div>
                </div>
                ...
                @if ($presensiHariIni)
                    <div class="flex items-center space-x-3">
                        @if ($presensiHariIni->status == 'belum_diabsen')
                            ...
                            <a href="{{ route('walas.manajemen-absen.show', $presensiHariIni->tanggal) }}"
                            ...
                            @forelse($presensi as $item)
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium border text-center">
                                        <a href="{{ route('walas.manajemen-absen.show', $item->tanggal) }}"
