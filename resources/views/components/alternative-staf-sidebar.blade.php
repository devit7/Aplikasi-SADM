<div>
    @props(['kelasId','staffAksesNilai','staffAksesAbsen'])
    ...
    <div class="relative flex flex-col bg-white h-screen w-64 border-r border-gray-200 shadow-lg">
        ...
        <div class="flex flex-col flex-grow p-4 overflow-y-auto">
            ...
            <a href="{{ route('staff.list-siswa', $kelasId) }}"
                class="mt-2 flex items-center px-4 py-3 text-gray-700 rounded-lg hover:bg-blue-100 hover:text-blue-600 transition-colors duration-200 {{ request()->routeIs('staff.list-siswa') ? 'bg-blue-100 text-blue-800' : '' }}">
