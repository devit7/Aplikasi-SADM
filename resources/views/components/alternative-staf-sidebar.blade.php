<div>
    @props(['kelasId','staffAksesNilai','staffAksesAbsen','staffAksesAlQuran','staffAksesExtra','staffAksesWorship'])
        ...
        <div class="relative flex flex-col bg-white h-screen w-64 border-r border-gray-200 shadow-lg">
            ...
            <div class="flex flex-col flex-grow p-4 overflow-y-auto">
                ...
                <a href="{{ route('staff.al-quran.index') }}"
                    class="mt-1 flex items-center px-4 py-3 text-gray-700 rounded-lg hover:bg-blue-100 hover:text-blue-600 transition-colors duration-200 {{ request()->routeIs('staff.al-quran.*') ? 'bg-blue-100 text-blue-800' : '' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-5 h-5 mr-3">
                ...
                <a href="{{ route('staff.extrakurikuler.index') }}"
                    class="mt-1 flex items-center px-4 py-3 text-gray-700 rounded-lg hover:bg-blue-100 hover:text-blue-600 transition-colors duration-200 {{ request()->routeIs('staff.extrakurikuler.*') ? 'bg-blue-100 text-blue-800' : '' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-5 h-5 mr-3">
                ...
                <a href="{{ route('staff.worship.index') }}"
                    class="mt-1 flex items-center px-4 py-3 text-gray-700 rounded-lg hover:bg-blue-100 hover:text-blue-600 transition-colors duration-200 {{ request()->routeIs('staff.worship.*') ? 'bg-blue-100 text-blue-800' : '' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-5 h-5 mr-3">
