...
use App\Filament\Resources\ExtrakurikulerStudentAssessmentResource\Pages;
...
class ExtrakurikulerStudentAssessmentResource extends Resource
{
   protected static ?string $model = ExtrakurikulerStudentAssessment::class;
   protected static ?string $navigationGroup = 'Ekstrakurikuler Course';
   protected static ?string $navigationLabel = 'Ekstrakurikuler Assessments';
   ...
   {
      return [
         'index' => Pages\ListExtrakurikulerStudentAssessments::route('/'),
         'create' => Pages\CreateExtrakurikulerStudentAssessment::route('/create'),
         'edit' => Pages\EditExtrakurikulerStudentAssessment::route('/{record}/edit'),
      ];
   }
}
