...
class StaffController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $staff_acces = (object)[
            ...
            'akses_alquran_learning' => $staff_acces_collection->where('kelas_id', $id)->contains('akses_alquran_learning', 1) ? 1 : 0,

            'akses_extrakurikuler' => $staff_acces_collection->where('kelas_id', $id)->contains('akses_extrakurikuler', 1) ? 1 : 0,

            'akses_worship_character' => $staff_acces_collection->where('kelas_id', $id)->contains('akses_worship_character', 1) ? 1 : 0,
        ];
